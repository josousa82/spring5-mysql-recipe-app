...
CREATE DATABASE IF NOT EXISTS recipe_app_prod DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
USE recipe_app_prod;

GRANT ALL PRIVILEGES ON recipe_app_prod.* to 'user'@'%' WITH GRANT OPTION;
